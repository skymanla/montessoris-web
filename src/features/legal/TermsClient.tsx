        ...
        <div className="prose prose-neutral max-w-none space-y-6 text-ink/75 prose-headings:font-display prose-headings:text-ink prose-strong:text-ink prose-a:text-sage-deep">
          {locale === "ko" ? (
            <>
              ...
              <h2 className="text-xl font-semibold text-ink mt-8">1. 서비스 이용</h2>
              <p>이용자는 본 약관 및 관련 법령을 준수하여 서비스를 이용해야 합니다. 회사는 정보 제공을 목적으로 웹사이트를 운영합니다.</p>

              <h2 className="text-xl font-semibold text-ink mt-8">2. 저작권</h2>
              <p>본 웹사이트에 게재된 모든 콘텐츠(텍스트, 이미지, 디자인 등)에 대한 저작권은 회사에 있으며, 사전 승인 없이 무단으로 복제하거나 배포할 수 없습니다.</p>

              <h2 className="text-xl font-semibold text-ink mt-8">3. 책임의 제한</h2>
            ...
            <>
              ...
              <h2 className="text-xl font-semibold text-ink mt-8">1. Use of Service</h2>
              ...
              <h2 className="text-xl font-semibold text-ink mt-8">2. Intellectual Property</h2>
              ...
              <h2 className="text-xl font-semibold text-ink mt-8">3. Limitation of Liability</h2>
